...
typedef struct spires_fault_system spires_fault_system;
...
typedef enum {
    ...
    SPIRES_FAULT_CLAMP_LOW // Clamps a random neuron's weights to 0 and activation to V_rest (or 0, not sure yet...)
} spires_fault_type;
/* ----------------------------
...
spires_status spires_generate_fault(spires_reservoir *r, const struct spires_fault_system *spires_fault_system);
// TODO
spires_status spires_restore_fault(spires_reservoir *r, const struct spires_fault_system *spires_fault_system);
